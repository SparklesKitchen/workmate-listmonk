...
func (c *Core) CreateList(l models.List) (models.List, error) {
	...
	var newID int
	l.UUID = uu.String()
	if err := c.q.CreateList.Get(&newID, l.UUID, l.Name, l.Type, l.Optin, l.Status, pq.StringArray(normalizeTags(l.Tags)), l.Description, l.Attribs); err != nil {
...
func (c *Core) UpdateList(id int, l models.List) (models.List, error) {
	...
	res, err := c.q.UpdateList.Exec(id, l.Name, l.Type, l.Optin, l.Status, pq.StringArray(normalizeTags(l.Tags)), l.Description, attribs)
	if err != nil {
